...
export const BTN_ENTER_AMOUNT = defineError(
	"BTN_ENTER_AMOUNT",
	"Enter amount",
);
export const BTN_NOT_ENOUGH_SHARES = defineError(
	"BTN_NOT_ENOUGH_SHARES",
	"Not enough shares",
);
export const BTN_NO_SHARES_TO_SELL = defineError(
	"BTN_NO_SHARES_TO_SELL",
	"No shares to sell",
);
export const BTN_FETCHING_PRICE = defineError(
	"BTN_FETCHING_PRICE",
	"Fetching price...",
);
...
export const BTN_NO_BIDS_AVAILABLE = defineError(
