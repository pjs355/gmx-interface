...
export function FirstSignupSetupGate() {
	...
	const shouldGate =
		privyReady && authenticated && Boolean(userId) && profileResolved && !onboardingCompletedAt;
	...
	return <FirstSignupSetupModal step={step} onAdvance={onAdvance} returnPath={returnPath} />;
}
