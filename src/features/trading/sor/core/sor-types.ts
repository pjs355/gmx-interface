export type SorVenue = "levelup" | "polymarket" | "dflow" | "predictfun" | "limitless";
...
export interface RouteRequest {
	...
	/** Ask server to fetch Pond and overlay DFlow leg economics (authenticated only). */
	includeDflowPondQuote?: boolean;
}

/** Pond GET /order economics (server-side overlay; not returned on route response). */
