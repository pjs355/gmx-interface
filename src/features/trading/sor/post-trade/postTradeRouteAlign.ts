...
import type { ExecutionLeg, RouteExecution, RoutePlan, SorVenue } from "../core/sor-types";
...
export function filledExecutionHasLevelUp(legs: readonly ExecutionLeg[]): boolean {
	return legs.some((l) => l.venue === "levelup" && l.status === "filled" && l.filledShares > 0);
}
