...
} from "@/features/trading/trade-preview/types";
...
import { BUTTON_LOADING_HOLD_MS, useStabilizedButtonResult } from "./venueButtonState/stabilizer";
...
export function useButtonState({
	...
	market: unknown;
	handleAddFunds: () => void;
	polymarketTrading?: Parameters<typeof resolveButtonState>[0]["polymarketTrading"];
	orderbookWalkPosition?: "yes" | "no";
	predictTrading?: Parameters<typeof resolveButtonState>[0]["predictTrading"];
	limitlessTrading?: Parameters<typeof resolveButtonState>[0]["limitlessTrading"];
