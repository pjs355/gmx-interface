...
export function trySorDepositToTrade(
	side: "buy" | "sell",
	sorState: SorStateForDeposit | undefined,
...
export function sorExecutingButtonLabel(
	...
	const prefundHop =
		prefundLegProgress && prefundLegProgress.total > 1 && prefundLegProgress.current >= 1
...
function sorRouteLoadingLabel(side: "buy" | "sell", smartRoutingTab: boolean): string {
	if (smartRoutingTab) {
