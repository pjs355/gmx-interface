/**
 * Venue tab changes with smart-routing guards and external `venueOverride` sync.
 *
 * Prevents switching venue mid-execute and locks All Markets when appropriate.
...
import type { VenuePositionEntry } from "@/features/trading/sor";
