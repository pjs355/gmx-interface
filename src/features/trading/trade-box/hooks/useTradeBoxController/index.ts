/**
 * Trade box controller — SOR quotes, execute, funding, and primary button state.
 *
 * Orchestrates `useTradeBoxQuotesLayer`, `useTradeBoxSorExecution`, venue
 * selection guards, and `useTradeBoxTradeButton`. This is the main "do trade"
 * layer above venue wiring and below presentational UI.
 *
 * `PredictionMarketTradeBox` passes runtime deps; UI receives derived `sorRoute`,
 * `sorExecution`, and `buttonState` via grouped props.
 */
...
import type { TradeBoxHookSetState } from "../useTradeState";
import { useTradeBoxSorFunding, type UseTradeBoxSorFundingArgs } from "./useTradeBoxSorFunding";
import { useTradeBoxQuotesLayer, type UseTradeBoxQuotesLayerArgs } from "./useTradeBoxQuotesLayer";
import {
...
import { useTradeBoxTradeButton, type UseTradeBoxTradeButtonArgs } from "./useTradeBoxTradeButton";
