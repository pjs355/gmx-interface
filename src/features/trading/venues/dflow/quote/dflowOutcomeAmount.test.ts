...
import { DFLOW_OUTCOME_BASE_UNIT_FACTOR, humanFromDflowBaseUnits } from "./dflowOutcomeAmount";

describe("humanFromDflowBaseUnits", () => {
	it("converts integer base units to human 6dp contracts", () => {
		expect(humanFromDflowBaseUnits(String(7 * DFLOW_OUTCOME_BASE_UNIT_FACTOR))).toBe(7);
