...
import type { PredictActivityEvent, PredictActivityEventName } from "./predictActivityApi";
 ...
 */
export function usePredictAccountActivity(opts: UsePredictAccountActivityOptions) {
	...
	return useQuery<PredictActivityEvent[], unknown>({
		...
		staleTime: 30_000,
		retry: 1,
		queryFn: () => api.getPredictAccountActivity({ first, eventTypes: types }),
