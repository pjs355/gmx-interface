...
import { type VenuePosition, type VenueHistoryFill } from "@/types/trading/venuePosition";
import { polymarketConditionLookupKey } from "@/features/trading/venues/polymarket/trade/polymarketConditionLookup";
import type { PredictUmbrellaLookup } from "@/features/trading/venues/predict/trade/resolvePredictUmbrellaFromMonitor";
...
import type { PredictMatchEventRow } from "@/features/trading/venues/predict/trade/predictMatchesApi";
import type { computePredictCostByToken } from "@/features/trading/venues/predict/portfolio/predictOrdersApi";
		...
		for (const trade of polyTradesArr) {
			...
			items.push({
				...
				outcomeResult:
					venueOutcomeResult ??
					trade.outcomeResult ??
					(trade.pnl !== null && trade.pnl !== undefined && trade.pnl > 0 ? "WON" : "LOST"),
				marketStatus: "RESOLVED",
			});
		}
