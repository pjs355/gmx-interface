			...
			{rows.length > 0 && (
				<>
					<div style={{
						...
						{orderMismatches > 0
							? <span>{orderMismatches} mismatch{orderMismatches > 1 ? 'es' : ''} (RPC ≠ orders)</span>
						...
						<table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 560 }}>
							<thead>
								<tr style={{ background: '#1a1a1a', textAlign: 'left' }}>
									...
									<th style={{ padding: '8px 12px', borderBottom: '1px solid #333', textAlign: 'right', width: 100 }}>Orders</th>
									<th style={{ padding: '8px 12px', borderBottom: '1px solid #333', textAlign: 'center', width: 80 }}>Match</th>
								</tr>
							</thead>
							<tbody>
								{rows.map((row, i) => {
