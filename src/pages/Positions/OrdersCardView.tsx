...
export default function OrdersCardView({ umbrellaBalances, orders }: { umbrellaBalances: any[]; orders: ProcessedOrder[] }) {
                    ...
                    >
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{ color: "#fff", fontSize: 16, fontWeight: 600 }}>
                          {isVs ? (
                            <>
                              <span>{o.position === 'Yes' ? parts[0] : parts[1]}</span>{" "}
                              <span style={{ color: o.side === "buy" ? "#16a34a" : "#ef4444" }}>
                                {o.side === 'buy' ? 'Buy' : 'Sell'}
                              </span>
                            </>
                          ) : (
                    ...
                    >
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{ color: "#fff", fontSize: 18, fontWeight: 700 }}>
                          {o.price !== undefined ? `${Math.round((o.price || 0) * 100)}¢` : "—"}
                        </div>
                      </div>
