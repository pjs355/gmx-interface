                      ...
                      >
                        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                          <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <span style={{ color: "#888", fontSize: 13 }}>Settlement Payout</span>
                            <span style={{ color: "#fff", fontSize: 13, fontWeight: 600 }}>
                              {settlementPayoutText}
                            </span>
                          </div>
                          <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <span style={{ color: "#888", fontSize: 13 }}>Total Cost</span>
                            <span style={{ color: "#fff", fontSize: 13, fontWeight: 600 }}>
                              {totalCostText}
                            </span>
                          </div>
                          <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <span style={{ color: "#888", fontSize: 13 }}>Total Payout</span>
                            <span style={{ color: totalPayoutColor, fontSize: 13, fontWeight: 600 }}>
                              {totalPayoutText}
                            </span>
                          </div>
                        </div>
