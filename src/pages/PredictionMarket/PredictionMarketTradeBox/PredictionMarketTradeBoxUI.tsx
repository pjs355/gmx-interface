...
import { usePostTradeAccountSyncPending } from "@/trading/sor/post-trade/usePostTradeAccountSync";
...
} from "./hooks/useTradeBoxVenueTabGuard";
...
import { positionToSorOutcome, type SorVenue } from "@/trading/sor";
...
export default function PredictionMarketTradeBoxUI({
	...
	const { selectedPosition, amount, price, orderType, side, orderResult, tradingVenue } =
		state;
			...
			<>
				...
				<SmartRoutingSection
					...
					sorExecutionRouteSourceQuestionId={
						sorRoute.executionRouteSourceQuestionId
					}
