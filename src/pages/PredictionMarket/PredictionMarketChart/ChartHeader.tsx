				...
				<div className="market-info primary-market">
					...
					<div className="current-price">
						<span
							...
							style={isVsSingleMarket ? { color: yesTeamColor } : undefined}
						>
							{Math.round(currentPrimary)}%
						</span>
						{showPrimaryLive && (
							<span
					...
					<div className="market-info second-market">
						...
						<div className="current-price">
							<span
								...
								style={isVsSingleMarket ? { color: noTeamColor } : undefined}
							>
								{Math.round(currentSecondary)}%
							</span>
							{showSecondaryLive && (
								<span
