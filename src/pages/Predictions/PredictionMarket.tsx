...
function PredictionMarketContent() {
	...
	const getLowestAsk = useCallback((questionId: string) => {
	...
	const sortedQuestions = useMemo(() => {
		...
		const sorted = [...questions].sort((a, b) => {
			...
			const previewA = questionIdA ? allBooksPreview[questionIdA] : undefined;
			const previewB = questionIdB ? allBooksPreview[questionIdB] : undefined;
		...
		console.log('🔀 Markets sorted by Yes price (highest first):', sorted.map(q => {
