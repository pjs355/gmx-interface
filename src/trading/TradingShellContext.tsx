...
export type TradingShellIntent =
	| "idle"
	| "fund_polymarket"
	| "bridge"
	| "deploy_safe"
...
const TradingShellContext = createContext<TradingShellContextValue | null>(
	null
);

export function TradingShellProvider({
	children,
}: {
	...
	return (
		<TradingShellContext.Provider value={value}>
			{children}
