import { waitForBaseTransactionSuccess } from "@/trading/chains/waitPrivyBaseTxReceipt";
import {
...
import { PREFUND_SHORTFALL_COVERED_EPS_USD } from "@/trading/sor/prefund/prefundPlan";
import { LIMITLESS_SCW_WITHDRAW_TIMEOUT_MS } from "@/trading/sor/prefund/sorBridgeWallTimeBudget";
import { withTimeout } from "@/utils/withTimeout";

export { LIMITLESS_SCW_WITHDRAW_TIMEOUT_MS } from "@/trading/sor/prefund/sorBridgeWallTimeBudget";
	...
	try {
		await withTimeout(
			waitForBaseTransactionSuccess(
				hash,
				"Limitless portfolio withdraw (USDC → Base SCW)",
			),
