...
export const SOR_LIFI_PREFUND_POLL_MAX_SLEEP_MS =
	SOR_LIFI_PREFUND_POLL_CONFIG.maxAttempts *
	SOR_LIFI_PREFUND_POLL_CONFIG.intervalMs;
...
export const LEG_OR_BRIDGE_TIMEOUT_MS =
	Math.max(SOR_PREFUND_SEQUENTIAL_MAX_MS, SOR_PARALLEL_SWEEP_MAX_MS) +
	SOR_LEG_OR_BRIDGE_MARGIN_MS;
