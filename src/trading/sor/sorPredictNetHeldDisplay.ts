...
import { limitlessNetOutcomeSharesHeldAfterBuy } from "@/pages/PredictionMarket/PredictionMarketTradeBox/feeLimitless";
...
export function sorBuyPredictLegNetHeldShares(
	...
	return predictFunNetOutcomeSharesHeldAfterBuy(
		leg.shares,
		leg.avgPrice,
