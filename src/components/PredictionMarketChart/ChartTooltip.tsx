...
export function ChartTooltip({ primaryTitle, secondaryTitle, isVsSingleMarket, formatTime }: {
  primaryTitle: string;
        ...
        <div className="prediction-chart-tooltip">
          ...
          {(secondaryTitle || isVsSingleMarket) && data.secondPercentage !== null && (
            <p className="tooltip-price second-tooltip">
              ...
              <span className="tooltip-value second-value">{data.secondPercentage.toFixed(2)}%</span>
            </p>
          )}
        </div>
      );
