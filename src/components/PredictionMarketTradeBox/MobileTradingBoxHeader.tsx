...
import type { TradeBoxCoreState } from "@/features/trading/trade-box/types";
import "./scss/MobileTradingBoxHeader.scss";
	...
	return (
		<div className="mobile-trading-header">
			<div className="mobile-trading-header-content">
				{/* Market title */}
				<div className="market-title-mobile">{market.displayName || market.question}</div>
						...
						<input
							...
							onChange={(e) => {
								...
								const maxFractionDigits =
									side === "buy" && orderType === "market" ? 2 : side === "sell" ? 2 : 8;
