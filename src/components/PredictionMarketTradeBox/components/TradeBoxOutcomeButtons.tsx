...
import { hexToRgba } from "@/features/markets/presentation/teamColors";
import { getBorderColorForSelected } from "@/features/markets/presentation/teamColors";
...
export default function TradeBoxOutcomeButtons({
	...
	return (
		<div
			...
			title={tradeInteractionLocked ? "Trade in progress — outcome locked" : undefined}
		>
			<Button
				...
				style={
					isVsSingle
						? {
								background:
									outcomeSelection === "yes" ? yesTeamColor : hexToRgba(yesTeamColor, 0.35),
