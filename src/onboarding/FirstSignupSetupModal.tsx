...
export function FirstSignupSetupModal(props: {
	...
	return (
		<RemoveScroll>
			...
			>
				<div
					className="first-signup-setup-modal__card"
					data-qa="first-signup-setup-modal"
				>
					{step === "venues" && (
						<>
							...
							<p className="first-signup-setup-modal__sub">
								We're getting everything ready so you can trade across all
								markets. This takes a few seconds.
							</p>
					...
					{step === "deposit" && (
						<>
							...
							<p className="first-signup-setup-modal__sub">
								Drop in some USDC to start trading. You can always come back
								here from the header.
							</p>
							<div className="first-signup-setup-modal__deposit-msg">
								Opening deposit…
							</div>
						</>
					)}
