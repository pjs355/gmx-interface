...
export const MIN_COLLATERAL_FACTOR_FOR_OPEN_INTEREST_MULTIPLIER_KEY = hashString("MIN_COLLATERAL_FACTOR_FOR_OPEN_INTEREST_MULTIPLIER");
...
export function subaccountExpiresAtKey(account, subaccount, actionType) {
    return hashData(["bytes32", "address", "address", "bytes32"], [SUBACCOUNT_EXPIRES_AT, account, subaccount, actionType]);
}
export function glvShiftLastExecutedAtKey(glvAddress) {
    return hashData(["bytes32", "address"], [GLV_SHIFT_LAST_EXECUTED_AT, glvAddress]);
}
export function glvShiftMinIntervalKey(glvAddress) {
    return hashData(["bytes32", "address"], [GLV_SHIFT_MIN_INTERVAL, glvAddress]);
}
export function glvMaxMarketTokenBalanceUsdKey(glvAddress, market) {
    return hashData(["bytes32", "address", "address"], [GLV_MAX_MARKET_TOKEN_BALANCE_USD, glvAddress, market]);
}
export function glvMaxMarketTokenBalanceAmountKey(glvAddress, market) {
    return hashData(["bytes32", "address", "address"], [GLV_MAX_MARKET_TOKEN_BALANCE_AMOUNT, glvAddress, market]);
}
export function isGlvDisabledKey(glvAddress, market) {
...
export function atomicSwapFeeFactorKey(market) {
...
export function openInterestInTokensKey(market, collateralToken, isLong) {
    return hashData(["bytes32", "address", "address", "bool"], [OPEN_INTEREST_IN_TOKENS_KEY, market, collateralToken, isLong]);
}
...
export function minCollateralFactorForOpenInterest(market, isLong) {
    return hashData(["bytes32", "address", "bool"], [MIN_COLLATERAL_FACTOR_FOR_OPEN_INTEREST_MULTIPLIER_KEY, market, isLong]);
}
...
export function maxPoolUsdForDepositKey(market, token) {
...
export function maxAllowedSubaccountActionCountKey(account, subaccount, actionType) {
    return hashData(["bytes32", "address", "address", "bytes32"], [MAX_ALLOWED_SUBACCOUNT_ACTION_COUNT, account, subaccount, actionType]);
}
export function subaccountActionCountKey(account, subaccount, actionType) {
    return hashData(["bytes32", "address", "address", "bytes32"], [SUBACCOUNT_ACTION_COUNT, account, subaccount, actionType]);
}
...
export function gaslessFeatureDisabledKey(module) {
