...
exports.ATOMIC_SWAP_FEE_FACTOR_KEY = (0, hash_1.hashString)("ATOMIC_SWAP_FEE_FACTOR");
...
exports.SUBACCOUNT_EXPIRES_AT = (0, hash_1.hashString)("SUBACCOUNT_EXPIRES_AT");
exports.PRICE_FEED_KEY = (0, hash_1.hashString)("PRICE_FEED");
exports.GASLESS_FEATURE_DISABLED_KEY = (0, hash_1.hashString)("GASLESS_FEATURE_DISABLED");
exports.GELATO_RELAY_FEE_MULTIPLIER_FACTOR_KEY = (0, hash_1.hashString)("GELATO_RELAY_FEE_MULTIPLIER_FACTOR");
exports.REQUEST_EXPIRATION_TIME_KEY = (0, hash_1.hashString)("REQUEST_EXPIRATION_TIME");
exports.GMX_SIMULATION_ORIGIN = "0x" + (0, hash_1.keccakString)("GMX SIMULATION ORIGIN").slice(-40);
function subaccountExpiresAtKey(account, subaccount, actionType) {
    return (0, hash_1.hashData)(["bytes32", "address", "address", "bytes32"], [exports.SUBACCOUNT_EXPIRES_AT, account, subaccount, actionType]);
}
exports.subaccountExpiresAtKey = subaccountExpiresAtKey;
...
function atomicSwapFeeFactorKey(market) {
    return (0, hash_1.hashData)(["bytes32", "address"], [exports.ATOMIC_SWAP_FEE_FACTOR_KEY, market]);
}
exports.atomicSwapFeeFactorKey = atomicSwapFeeFactorKey;
...
function priceFeedKey(token) {
    return (0, hash_1.hashData)(["bytes32", "address"], [exports.PRICE_FEED_KEY, token]);
}
exports.priceFeedKey = priceFeedKey;
function gaslessFeatureDisabledKey(module) {
    return (0, hash_1.hashData)(["bytes32", "address"], [exports.GASLESS_FEATURE_DISABLED_KEY, module]);
}
exports.gaslessFeatureDisabledKey = gaslessFeatureDisabledKey;
