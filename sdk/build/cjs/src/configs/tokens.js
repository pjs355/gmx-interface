    ...
    [chains_1.BASE]: [
        {
            name: "GMX Market tokens",
            symbol: "GM",
            address: viem_1.zeroAddress, // Use a placeholder for now if you don't have one
            decimals: 18,
            imageUrl: "https://raw.githubusercontent.com/gmx-io/gmx-assets/main/GMX-Assets/PNG/GM_LOGO.png",
            isPlatformToken: true,
        },
        ...
        },
        {
            name: "Taylor Swift",
            symbol: "Lettuce",
            address: "0xe0Ac26638013932FfDE447E8ab692f9e24a1219F",
            decimals: 6,
            priceDecimals: 2,
            categories: ["music"],
            imageUrl: "https://assets.coingecko.com/coins/images/53775/standard/melania-meme.png?1737329885",
        ...
        },
        {
            name: "Coldplay",
            symbol: "Chicken",
            address: "0xE1f5680328E305Ea78f1a306f02ba12Ff0f10AcE",
            decimals: 6,
            priceDecimals: 2,
            categories: ["music"],
            imageUrl: "https://assets.coingecko.com/coins/images/53775/standard/melania-meme.png?1737329885",
        ...
        },
        {
            name: "Chainsmokers",
            symbol: "Milk",
            address: "0xc343a7f2A10CfE947773f5628AdD86C86A4281A5",
            decimals: 6,
            priceDecimals: 2,
            categories: ["music"],
            imageUrl: "https://assets.coingecko.com/coins/images/53775/standard/melania-meme.png?1737329885",
...
const CHAIN_IDS = [chains_1.ARBITRUM, chains_1.AVALANCHE, chains_1.AVALANCHE_FUJI, chains_1.BOTANIX, chains_1.BASE];
for (let j = 0; j < CHAIN_IDS.length; j++) {
    ...
    if (exports.NATIVE_TOKENS_MAP[chainId]) {
...
function getTokenBySymbol(chainId, symbol, { isSynthetic, version, symbolType = "symbol", } = {}) {
    ...
    if (!token) {
        console.error('Available tokens for chainId', chainId, ':', Object.keys(exports.TOKENS_BY_SYMBOL_MAP[chainId]));
